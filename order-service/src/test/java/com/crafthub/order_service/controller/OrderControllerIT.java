...
@Testcontainers
@Disabled("Disabled due to Docker Desktop / Testcontainers compatibility issue on Windows (BadRequestException). Enable when running in CI or fixed Docker environment.")
