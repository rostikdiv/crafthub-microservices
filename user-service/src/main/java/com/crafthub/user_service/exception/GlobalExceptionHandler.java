package com.crafthub.user_service.exception;

import com.crafthub.user_service.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    // Специфічна помилка для логіну (невірний пароль)
    @ExceptionHandler(BadCredentialsException.class)
    public ResponseEntity<ErrorResponse> handleBadCredentials(BadCredentialsException ex, HttpServletRequest request) {
        return buildResponse(HttpStatus.UNAUTHORIZED, "Невірний email або пароль", request.getRequestURI(), null);
    }
    ...
    public ResponseEntity<ErrorResponse> handleAccessDenied(AccessDeniedException ex, HttpServletRequest request) {
        return buildResponse(HttpStatus.FORBIDDEN, "Відмовлено в доступі", request.getRequestURI(), null);
    }
