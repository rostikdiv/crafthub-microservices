...
/**
 * Google Cloud Storage implementation of FileStorageService using native GCS SDK and Cloud Run ADC.
 */
@Service
@Profile("cloud")
@Slf4j
public class GcsFileStorageService implements FileStorageService {
    ...
    public String uploadFile(MultipartFile file, String bucketName) {
        ...
        log.info("Uploaded file to GCS: gs://{}/{}", bucketName, fileName);
    ...
    public InputStream getFile(String bucketName, String objectName) {
        ...
        if (blob == null) {
            throw new RuntimeException("File not found in GCS bucket " + bucketName + ": " + objectName);
        }
