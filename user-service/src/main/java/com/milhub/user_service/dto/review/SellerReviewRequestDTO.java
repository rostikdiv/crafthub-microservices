package com.milhub.user_service.dto.review;
...
/**
 * Data Transfer Object for submitting a review for a seller.
 */
public record SellerReviewRequestDTO(
                @NotNull(message = "Seller ID is required") UUID sellerId,
