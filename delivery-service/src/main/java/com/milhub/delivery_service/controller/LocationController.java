...
public class LocationController {
    ...
    public ResponseEntity<String> importLocations(
            @RequestBody List<com.milhub.delivery_service.dto.request.LocationCreateDTO> locations) {
    ...
    public ResponseEntity<Void> updateLocation(
            ...
            @RequestBody com.milhub.delivery_service.dto.request.LocationUpdateDTO dto) {
    ...
    public ResponseEntity<Void> updateBranch(
            @PathVariable UUID id,
            @RequestBody com.milhub.delivery_service.dto.request.BranchUpdateDTO dto) {
