...
public class LocationService {
    ...
    @Transactional
    public void addBranchToLocation(UUID locationId, com.milhub.delivery_service.dto.request.BranchCreateDTO dto) {
    ...
    @Transactional
    public void updateLocation(UUID locationId, com.milhub.delivery_service.dto.request.LocationUpdateDTO dto) {
        Location location = locationRepository.findById(locationId)
                .orElseThrow(() -> new ResourceNotFoundException("Location not found")); // ✅
    ...
    @Transactional
    public void updateBranch(UUID branchId, com.milhub.delivery_service.dto.request.BranchUpdateDTO dto) {
